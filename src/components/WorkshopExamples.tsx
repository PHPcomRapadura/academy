...
const WorkshopExamples = () => {
  return (
    <section className="absolute inset-0 overflow-hidden pointer-events-none opacity-20">
      ...
      <div className="relative py-24 md:py-32 overflow-hidden bg-gradient-to-b from-muted/30 via-background to-muted/30">
              ...
              >
                ...
                <div className="relative h-full bg-card backdrop-blur-sm p-8 rounded-3xl border-2 border-border/50 group-hover:border-primary/50 transition-all duration-300 shadow-soft group-hover:shadow-hover group-hover:scale-105">
                  ...
                  <div className="space-y-3">
                    <p className="text-sm font-bold text-foreground/70 uppercase tracking-wide">
                      Tópicos:
                    </p>
