      ...
      <div className="container mx-auto px-4 py-20 relative z-10">
        <div className="max-w-6xl mx-auto text-center space-y-10 animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center pt-6">
            <Button
              size="lg"
              className="group relative text-xl px-12 py-8 bg-gradient-nordeste hover:bg-gradient-nordeste/90 text-primary shadow-glow hover:shadow-hover transition-all duration-300 hover:scale-105 font-bold rounded-2xl"
              asChild
            >
              <a
